<?php 
	...
	try {
	    ...
	    $mail->Username   = 'testeconta01232@gmail.com';                     //SMTP username
	    $mail->Password   = 'eutxrodpzxvqulic';                               //SMTP password
	    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
	    $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

	    //Recipients
	    $mail->setFrom('testeconta01232@gmail.com', 'testeconta01232');
	...
	// email = testeconta01232@gmail.com
	// nome = contateste sobrenome = testeconta
	// senha =  ContatesteTesteConta123$
	// 13:27 --- vontando na aula
	...
	senha aleatória ContatesteTesteConta123@
	...
	// Sua senha de app para seu dispositivo eutxrodpzxvqulic
